...
"""Run a graph-state example through the IQM QDMI Qiskit backend."""
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for the graph-state example.
...
def main() -> None:
    """Execute the graph-state example.
    ...
    if backend.num_qubits < args.num_qubits:
        msg = (
            f"Selected backend exposes {backend.num_qubits} qubits, but the graph-state example "
