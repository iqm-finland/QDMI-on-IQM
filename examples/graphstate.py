...
"""Prepare and sample from a graph state using the QDMI-on-IQM stack."""
...
if __name__ == "__main__":
    ...
    log.info(
        "Starting graph-state example (backend=%s, qubits=%d, shots=%d)",
        args.backend,
        args.num_qubits,
        args.shots,
    )
    ...
    log.info("Building and mapping graph-state benchmark circuit (n=%d)...", args.num_qubits)
