...
"""Run a W-state showcase through the IQM QDMI Qiskit backend."""
...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for the W-state showcase.
...
def main() -> None:
    ...
    if backend.num_qubits < args.num_qubits:
        msg = f"Selected backend exposes {backend.num_qubits} qubits, but the W-state showcase needs {args.num_qubits}."
        raise SystemExit(msg)
