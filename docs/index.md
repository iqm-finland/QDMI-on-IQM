...
For users working through the `qiskit` extra, the documentation also includes end-user showcases demonstrating how the packaged backend can drive benchmark circuits and quantum-chemistry tasks directly.
